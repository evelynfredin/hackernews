...
<body class="bg-gray-100 mx-5 lg:mx-30 text-primary-400 font-body dark:bg-primary-400 dark:text-primary-200">
    <header class="container mx-auto flex justify-between py-6 items-center border-b border-gray-200">
        ...
        <button class="btn bg-primary-200 hover:bg-primary-300 text-primary-400 hover:text-primary-100 dark:bg-primary-500 dark:hover:bg-primary-400 md:hidden">
        ...
        <div class="hidden md:block">
            <ul class="flex uppercase font-special font-semibold text-lg">
                ...
                <li><a class="btn bg-accent ml-4 hover:bg-primary-100" href=" {{ route('register') }}">Sign Up</a></li>
            </ul>
        </div>
    </header>
